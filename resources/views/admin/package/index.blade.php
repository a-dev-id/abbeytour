    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 mb-3">
                <a href="{{ route('package.create') }}" class="btn btn-sm btn-success text-white"><i class="fa-solid fa-circle-plus"></i> Add New</a>
            </div>
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                                ...
                                @foreach ($packages as $t)
                                    <tr>
                                        ...
                                        <td class="text-end align-middle">
                                            <a href="{{ route('package.edit', [$t->id]) }}" class="btn btn-warning btn-sm text-white"><i class="fa-solid fa-edit"></i></a>
                                            ...
                                            <div class="modal fade" id="deleteModal{{ $t->id }}" tabindex="-1" aria-labelledby="deleteModal{{ $t->id }}Label" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <form method="POST" action="{{ route('package.destroy', [$t->id]) }}">
                                                            @csrf
                                                            @method('DELETE')
