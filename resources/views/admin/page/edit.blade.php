...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb ms-2 my-0">
            ...
            <li class="breadcrumb-item">
                <span><a href="{{ route('page.index') }}" class="text-dark">@yield('title')</a></span>
            </li>
...
<x-app-layout>
    <div class="container-fluid">
        <form method="POST" enctype="multipart/form-data" action="{{ route('page.update', [$page->id]) }}" class="row">
            @method('PUT')
            @csrf
            <div class="col-8">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" id="title" class="form-control" name="title" placeholder="Title" value="{{ $page->title }}">
                        </div>
                        <div class="mb-3">
                            <label for="excerpt" class="form-label">Excerpt</label>
                            <textarea id="excerpt" class="form-control" name="excerpt" placeholder="Excerpt">{{ $page->excerpt }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label for="description" class="form-label">Description</label>
                            <textarea id="description" class="form-control" name="description" placeholder="Description">{{ $page->description }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body row">
                        <div class="col-8">
                            <div class="card">
                                <div class="card-body p-0">
                                    <img src="{{ asset('storage/' . $page->banner_image) }}" alt="" class="w-100">
                                </div>
                        ...
                        <div class="col-4">
                            <div class="card">
                                <div class="card-body p-0">
                                    <img src="{{ asset('storage/' . $page->cover_image) }}" alt="" class="w-100">
                                </div>
                                <div class="card-footer">
                                    Cover Image
                                </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="hidden" name="old_banner_image" value="{{ $page->banner_image }}">
                            <div id="coverImageSize" class="form-text">Image size 1920px x 500px</div>
                        </div>
                        <div class="mb-3">
                            <label for="status" class="form-label">Status</label>
                            <select class="form-select" id="status" name="status">
                                <option value="1" @if ($page->status == 1) selected @else @endif>Publish</option>
                                <option value="0" @if ($page->status == 0) selected @else @endif>Draft</option>
                            </select>
                        </div>
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="feature" name="featured" @if ($page->featured == 'on') checked @else @endif>
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="px-2"></div>
                            <a href="{{ route('page.index') }}" class="btn btn-danger btn-sm text-white w-100"><i class="fa-solid fa-ban"></i> Cancel</a>
                        </div>
                    </div>
                </div>
            </div>
