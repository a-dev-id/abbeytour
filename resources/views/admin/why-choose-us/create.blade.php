...
<x-app-layout>
    <div class="container-fluid">
        <form method="POST" enctype="multipart/form-data" action="{{ route('why-choose-us.store') }}" class="row">
            @csrf
            <div class="col-8">
                <div class="card mb-5">
                ...
                <div class="card mb-5">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" id="font_awesome" class="form-control" name="font_awesome" placeholder="Font Awesome Icon" aria-describedby="iconFontAwesome">
